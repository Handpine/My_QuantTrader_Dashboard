...
* 🏆 **[純台股實戰本金量化策略全決策白皮書](backtest_reports/real_capital_strategy_plan.md)**  
...
* 📘 **[量化評估指標與算式指南](backtest_reports/quant_evaluation_metrics_guide.md)**  
...
本專案於 `.github/workflows/auto_trader.yml` 部署了全自動化 GitHub Actions 流程：
