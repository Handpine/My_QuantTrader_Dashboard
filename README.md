...
* 🏆 **[純台股實戰本金量化策略全決策白皮書](file:///c:/Users/USER/finished_works/My_QuantTrader/backtest_reports/real_capital_strategy_plan.md)**  
  **【全策略核心藍圖】** 包含 300 萬總本金與 100 萬虛擬帳戶實戰設定、選股池標的篩選、70/30 多空劃分、模型 2 風險平坦度個股權重、方法 A 利潤撥轉活存保本、組合二狀態延續型分別參數，以及 7 年訓練集 (2018-2024) 與 1.5 年盲測集 (2025-2026) 全對比與大盤 Benchmark 全審計。
...
### 1. 🟢 70% 多頭波段帳戶 (70 萬新台幣底金 / 300萬實戰 210 萬)
...
### 2. 🛡️ 30% 空頭防禦與獲利撥轉帳戶 (30 萬新台幣底金 / 300萬實戰 90 萬)
...
## ⏰ GitHub Actions 實戰下單觸發時點

為提供給長輩當天下單建議，GitHub Actions 設定為每日台股交易日 **4 定點觸發**：

* 🌅 **09:30 TST**：早盤趨勢觀察與跳空缺口試探
* ☀️ **11:30 TST**：午盤量價波動觀察
* 🏆 **13:15 TST**：**【最關鍵收盤前15分鐘訊號】** 當天收盤價 99% 定型，長輩可直接在手機 App 下單撮合！
* 🌙 **14:00 TST**：盤後最終結算與 PWA Live Dashboard 自動同步
...
```text
├── .github/workflows/
│   └── auto_trader.yml                 # 每日 4 次自動執行與台股下單訊號更新
...
├── index.html                          # PWA 磨砂玻璃風實戰儀表板 (含刷新按鈕與 Calmar/Sortino)
